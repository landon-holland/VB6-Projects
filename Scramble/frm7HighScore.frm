VERSION 5.00
Begin VB.Form frm7HighScore 
   Caption         =   "7-Letter Highscores"
   ClientHeight    =   3300
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   4875
   ...
   Begin VB.ListBox lstNames 
      Appearance      =   0  'Flat
      Height          =   1980
      ItemData        =   "frm7HighScore.frx":0000
      Left            =   105
      List            =   "frm7HighScore.frx":0002
      TabIndex        =   3
      Top             =   480
      Width           =   2000
   End
   Begin VB.ListBox lstScoresReal 
      Appearance      =   0  'Flat
      Height          =   1980
      ItemData        =   "frm7HighScore.frx":0004
      Left            =   2760
      List            =   "frm7HighScore.frx":0006
      TabIndex        =   2
      Top             =   480
      Width           =   2000
   End
   ...
   Begin VB.ListBox lstScores 
      Appearance      =   0  'Flat
      Height          =   1980
      ItemData        =   "frm7HighScore.frx":0008
      Left            =   1200
      List            =   "frm7HighScore.frx":000A
      Sorted          =   -1  'True
      TabIndex        =   0
      Top             =   360
      Visible         =   0   'False
   ...
   End
End
Attribute VB_Name = "frm7HighScore"
...
Open "D:\CP1\VB6 Project Files\Scramble\resources\highscores\7scores.txt" For Input As #1
...
Open "D:\CP1\VB6 Project Files\Scramble\resources\highscores\7names.txt" For Input As #1
...
If Not globalscore = -1 Then
    ...
    If Format(globalscore, "@@@@@") >= lstScoresReal.List(9) Then
        ...
        Open "D:\CP1\VB6 Project Files\Scramble\resources\highscores\7scores.txt" For Output As #1
        ...
        Open "D:\CP1\VB6 Project Files\Scramble\resources\highscores\7names.txt" For Output As #1
